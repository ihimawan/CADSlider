// Name: Indri Himawan
// Completed on March 25th, 2016
// CS 4395 - Project 2 (cad1.js)
...
window.onload = function init() {
    ...
    canvas.addEventListener("mousedown", function(event){
        ...
        if(first) {
          ...
          var r = ((parseInt(document.getElementById('redValue').value))/255).toFixed(2);
          var g = ((parseInt(document.getElementById('greenValue').value))/255).toFixed(2);
          var b = ((parseInt(document.getElementById('blueValue').value))/255).toFixed(2);
